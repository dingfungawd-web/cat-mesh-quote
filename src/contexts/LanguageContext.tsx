...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    "ref2.single": "一隻貓飼養",
    "ref2.single.point1": "行為風險相對可控，主要風險來自貓咪自身的「探索本能」及「狩獵反應」",
    "ref2.single.point2": "突發風險：見到雀鳥、昆蟲時的瞬間撲擊",
    "ref2.single.point3": "建議：防貓網需承受單貓體重的 8-12 倍衝擊力",
    "ref2.double": "兩隻貓飼養",
    "ref2.double.point1": "社交追逐是最常見行為，一方逃跑另一方追趕，易形成高速衝撞",
    "ref2.double.point2": "遊戲中可能同時撞擊同一位置，衝擊力疊加",
    "ref2.double.point3": "領地爭奪時可能於窗邊發生「摔角」或「追打」",
    "ref2.double.point4": "建議：防貓網需承受兩隻貓體重總和的 10-15 倍衝擊力",
    "ref2.multiple": "三隻或以上多貓飼養",
    "ref2.multiple.point1": "「群體暴衝」：一隻貓驚嚇後，可能引發連鎖反應，多隻貓同時奔跑",
    "ref2.multiple.point2": "社交等級競爭更頻繁，打架可能更激烈",
    "ref2.multiple.point3": "同一窗口可能長期有多隻貓躺臥，增加靜態負荷",
    "ref2.multiple.point4": "建議：防貓網需達到商業級別強度，並於高頻使用位置加固",
    ...
    "ref3.scratch": "持續抓撓",
    "ref3.scratchMultiplier": "集中力",
    "ref3.scratchImpact": "~2-3 kg/cm²",
  ...
  en: {
    ...
    "ref2.single.point1": "Behavioral risk is relatively controllable, main risks come from cat's 'exploration instinct' and 'hunting response'",
    "ref2.single.point2": "Sudden risk: Instant pouncing when seeing birds or insects",
    "ref2.single.point3": "Recommendation: Cat net should withstand 8-12 times single cat's body weight impact",
    "ref2.double": "Two Cat Household",
    "ref2.double.point1": "Social chasing is the most common behavior, one runs and the other chases, easily forming high-speed collisions",
    "ref2.double.point2": "During play, may simultaneously hit the same position, stacking impact forces",
    "ref2.double.point3": "Territory disputes may cause 'wrestling' or 'fighting' near windows",
    "ref2.double.point4": "Recommendation: Cat net should withstand 10-15 times combined weight of two cats",
    "ref2.multiple": "Three or More Cats",
    "ref2.multiple.point1": "'Group zoomies': When one cat is startled, may trigger chain reaction with multiple cats running simultaneously",
    "ref2.multiple.point2": "Social hierarchy competition more frequent, fights may be more intense",
    "ref2.multiple.point3": "Multiple cats may lie at the same window for extended periods, increasing static load",
    "ref2.multiple.point4": "Recommendation: Cat net should reach commercial-grade strength, with reinforcement at high-frequency use areas",
    ...
    "ref3.scratchMultiplier": "Concentrated",
    "ref3.scratchImpact": "~2-3 kg/cm²",
