...
export function AssessmentResult({ formData, totalScore, onReset }: AssessmentResultProps) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto animate-fade-in">
      ...
      {/* PAGE 2-4: Reference materials - keeping original Chinese content for PDF accuracy */}
      <div ref={page2Ref} className="space-y-4 bg-background p-4">
        <Card className="p-4 shadow-lg"><div className="flex items-center gap-3"><img src={dfLogo} alt="DF" className="h-8 w-auto" /><div><h2 className="text-base font-bold">{t("ref1.title")}</h2><p className="text-xs text-muted-foreground">{t("ref1.desc")}</p></div></div></Card>
        <Card className="p-5 shadow-lg"><p className="text-xs text-muted-foreground text-center">{t("ref1.note")}</p></Card>
      </div>

      <div ref={page3Ref} className="space-y-4 bg-background p-4 mt-6">
        <Card className="p-4 shadow-lg"><div className="flex items-center gap-3"><img src={dfLogo} alt="DF" className="h-8 w-auto" /><div><h2 className="text-base font-bold">{t("ref2.title")}</h2><p className="text-xs text-muted-foreground">{t("ref2.desc")}</p></div></div></Card>
        <Card className="p-5 shadow-lg"><p className="text-xs text-muted-foreground text-center">{t("ref2.note")}</p></Card>
      </div>

      <div ref={page4Ref} className="space-y-4 bg-background p-4 mt-6">
        <Card className="p-4 shadow-lg"><div className="flex items-center gap-3"><img src={dfLogo} alt="DF" className="h-8 w-auto" /><div><h2 className="text-base font-bold">{t("ref3.title")}</h2><p className="text-xs text-muted-foreground">{t("ref3.desc")}</p></div></div></Card>
        <Card className="p-4 shadow-lg bg-gradient-card"><div className="text-center"><p className="text-xs text-muted-foreground">{t("ref3.footer")}</p></div></Card>
      </div>
